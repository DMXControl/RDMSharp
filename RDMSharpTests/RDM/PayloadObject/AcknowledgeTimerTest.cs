...
public class AcknowledgeTimerTest
{
    ...
    public void ToPayloadAndFromMessageTest()
    {
        ...
        RDMMessage message = new RDMMessage(acknowledgeTimer)
        {
        ...
        Assert.Throws(typeof(RDMMessageInvalidPDLException), () => { AcknowledgeTimer.FromPayloadData(new byte[2].ToList().Concat(new byte[1]).ToArray()); });
