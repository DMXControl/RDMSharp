...
namespace RDMSharpTest.RDM
{
    public class TCPCommsEntryTest
    {
        ...
        public void ToPayloadAndFromMessageTest()
        {
            ...
            Assert.AreEqual(tcpCommsEntryTest, resultTCPCommsEntryTest); tcpCommsEntryTest = new TCPCommsEntry("Pseudo TCPCommsEntryTest", IPAddress.Parse("2001:db8:0:0:0:0:1428:57ab"), 2347,99);
            ...
            Assert.AreEqual(tcpCommsEntryTest, resultTCPCommsEntryTest);
        }
        [Test]
