using RDMSharp.Extensions.BytesParser;
using RDMSharp.Extensions.BytesParser.StringFormats;
...
public class TestBytesType
{
    ...
    public void TestParseUID()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new UIDBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new UIDBytesParser().ParseToData("WrongType"));
    ...
    public void TestParseIPv4()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new IPv4AddressBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new IPv4AddressBytesParser().ParseToData("WrongType"));
    ...
    public void TestParseIPv6()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new IPv6AddressBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new IPv6AddressBytesParser().ParseToData("WrongType"));
    ...
    public void TestParseMAC()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new MACAddressBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new MACAddressBytesParser().ParseToData("WrongType"));
    ...
    public void TestParseGUID()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new GuidBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new GuidBytesParser().ParseToData("WrongType"));

        Assert.Throws(typeof(ArgumentException), () => new UuidBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new UuidBytesParser().ParseToData("WrongType"));
    }
    [Test]
    public void TestParseDouble()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new DoubleBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new DoubleBytesParser().ParseToData("WrongType"));
    ...
    public void TestParseFloat()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new FloatBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new FloatBytesParser().ParseToData("WrongType"));
    ...
    public void TestParsePID()
    {
        ...
        byte[] lessBytes = new byte[] { 0 };
        Assert.Throws(typeof(ArgumentException), () => new PIDBytesParser().ParseToObject(ref lessBytes));
        Assert.Throws(typeof(ArgumentException), () => new PIDBytesParser().ParseToData("WrongType"));
    ...
    public void TestParseASCII()
    {
        ...
        var pdl = bytesType.GetDataLength();
        Assert.That(pdl, Is.EqualTo(new PDL(1, PDL.MAX_LENGTH)));
        ...
        Assert.Throws(typeof(ArgumentException), () => new ASCIIBytesParser().ParseToData(0x44));
    ...
    public void TestParseUTF8()
    {
        ...
        Assert.Throws(typeof(ArgumentException), () => new UTF8BytesParser().ParseToData(0x44));
    ...
    public void TestParseUTF32()
    {
        ...
        Assert.Throws(typeof(ArgumentException), () => new UTF32BytesParser().ParseToData(0x44));
    ...
    public void TestParseUnicode()
    {
        ...
        Assert.Throws(typeof(ArgumentException), () => new UnicodeBytesParser().ParseToData(0x44));
    ...
    public void TestParseBigEndianUnicode()
    {
        ...
        Assert.Throws(typeof(ArgumentException), () => new BigEndianUnicodeBytesParser().ParseToData(0x44));
    ...
    public void TestParseLatin1()
    {
        ...
        Assert.Throws(typeof(ArgumentException), () => new Latin1BytesParser().ParseToData(0x44));
