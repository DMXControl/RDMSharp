...
public readonly struct DataTree : IEquatable<DataTree>
{
    ...
    private DataTree(string name, uint index, DataTreeIssue[]? issues = null, bool isCompound = false, bool isList = false)
    {
        Name = name;
        Index = index;
        Issues = issues;
    ...
    public DataTree(DataTree dataTree, uint index) : this(dataTree.Name, index, dataTree.Issues, dataTree.IsCompound, dataTree.IsList)
    {
    ...
    public DataTree(string name, uint index, object value, DataTreeIssue[]? issues = null, string unit = null, DataTreeValueLabel[] labels = null, bool isCompound = false, bool isList = false) : this(name, index, issues, isCompound, isList)
    {
    ...
    public DataTree(string name, uint index, DataTree[] children, DataTreeIssue[]? issues = null, bool isCompound = false, bool isList = false) : this(name, index, issues, isCompound, isList)
    {
        Children = children;
    }
