...
public class GetEndpointRespondersResponse : AbstractRDMPayloadObject
{
    ...
    public GetEndpointRespondersResponse(
        ...
        [DataTreeObjectParameter("list_change_number")] uint listChangedNumber = default,
        [DataTreeObjectParameter(ERDM_Parameter.ENDPOINT_RESPONDERS, "uids", true)] params UID[] uids)
    {
    ...
    public override string ToString()
    {
        ...
        b.AppendLine($"EndpointId: {EndpointId.ToString("X")}");
