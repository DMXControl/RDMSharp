...
public class RDMPersonalityId : AbstractRDMPayloadObject, IRDMPayloadObjectIndex
{
    ...
    public RDMPersonalityId(
        ...
        [DataTreeObjectParameter("major_id")] uint majorPersonalityId = 0,
        [DataTreeObjectParameter("minor_id")] uint minorPersonalityId = 0)
    {
        this.PersonalityId = personalityId;
        this.MajorPersonalityId = majorPersonalityId;
    ...
    public uint MajorPersonalityId { get; private set; }
    [DataTreeObjectProperty("minor_id", 2)]
    public uint MinorPersonalityId { get; private set; }
