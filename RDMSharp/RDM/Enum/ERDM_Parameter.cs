...
public enum ERDM_Parameter : ushort
{
    ...
    [ParameterGroup("Status"), ParameterUpdateTime(30000)]
    ...
    [ParameterGroup("Info"), ParameterUpdateTime(602000)]
    DEVICE_MODEL_DESCRIPTION = 0x0080,
    [ParameterGroup("Info"), ParameterUpdateTime(603000)]
    MANUFACTURER_LABEL = 0x0081,
    [ParameterGroup("Info"), ParameterUpdateTime(364000)]
    DEVICE_LABEL = 0x0082,
    [ParameterGroup("Control"), ParameterUpdateTime(180000)]
    FACTORY_DEFAULTS = 0x0090,
    [ParameterGroup("Control")]
    LANGUAGE_CAPABILITIES = 0x00A0,
    [ParameterGroup("Control"), ParameterUpdateTime(300000)]
    LANGUAGE = 0x00B0,
    [ParameterGroup("Firmware"), ParameterUpdateTime(121000)]
    SOFTWARE_VERSION_LABEL = 0x00C0,
    [ParameterGroup("Firmware"), ParameterUpdateTime(302000)]
    BOOT_SOFTWARE_VERSION_ID = 0x00C1,
    [ParameterGroup("Firmware"), ParameterUpdateTime(302000)]
    BOOT_SOFTWARE_VERSION_LABEL = 0x00C2,

    [ParameterGroup("DMX"), ParameterUpdateTime(62000)]
    DMX_PERSONALITY = 0x00E0,
    [ParameterGroup("DMX")]
    DMX_PERSONALITY_DESCRIPTION = 0x00E1,
    [ParameterGroup("DMX"), ParameterUpdateTime(65000)]
    ...
    [ParameterGroup("Sensors"), ParameterUpdateTime(20000)]
    SENSOR_VALUE = 0x0201,
    [ParameterGroup("Sensors")]
    RECORD_SENSORS = 0x0202,

    [ParameterGroup("Info"), ParameterUpdateTime(301000)]
    DEVICE_HOURS = 0x0400,
    [ParameterGroup("Lamp"), ParameterUpdateTime(302000)]
    LAMP_HOURS = 0x0401,
    [ParameterGroup("Lamp"), ParameterUpdateTime(303000)]
    LAMP_STRIKES = 0x0402,
    [ParameterGroup("Lamp"), ParameterUpdateTime(30400)]
    LAMP_STATE = 0x0403,
    [ParameterGroup("Lamp"), ParameterUpdateTime(60500)]
    LAMP_ON_MODE = 0x0404,
    [ParameterGroup("Info"), ParameterUpdateTime(126000)]
    DEVICE_POWER_CYCLES = 0x0405,

    [ParameterGroup("Display"), ParameterUpdateTime(307000)]
    ...
    [ParameterGroup("Control")]
    RESET_DEVICE = 0x1001,
    [ParameterGroup("Control"), ParameterUpdateTime(30000)]
    POWER_STATE = 0x1010,
    [ParameterGroup("Control")]
    ...
    [ParameterGroup("DMX"), ParameterUpdateTime(300000)]
    ...
    [ParameterGroup("Dimming"), ParameterUpdateTime(30000)]
    CURVE = 0x0343,
    [ParameterGroup("Dimming")]
    ...
    //E1.37-5 - 2024
    [ParameterGroup("URL"), ParameterUpdateTime(600000)]
    MANUFACTURER_URL = 0x00D0,
    [ParameterGroup("URL"), ParameterUpdateTime(600000)]
    PRODUCT_URL = 0x00D1,
    [ParameterGroup("URL"), ParameterUpdateTime(600000)]
    FIRMWARE_URL = 0x00D2,
    [ParameterGroup("Info"), ParameterUpdateTime(600000)]
    ...
    [ParameterGroup("Tag"), ParameterUpdateTime(60000)]
    LIST_TAGS = 0x0651,
    [ParameterGroup("Tag")]
    ADD_TAG = 0x0652,
    [ParameterGroup("Tag")]
    ...
    [ParameterGroup("Tag")]
    CLEAR_TAGS = 0x0655,
    [ParameterGroup("Info"), ParameterUpdateTime(120000)]
    DEVICE_UNIT_NUMBER = 0x0656,
    [ParameterGroup("DMX"), ParameterUpdateTime(120000)]
    DMX_PERSONALITY_ID = 0x00E2,
    [ParameterGroup("Sensor")]
    SENSOR_TYPE_CUSTOM = 0x0210,
    [ParameterGroup("Sensor")]
    SENSOR_UNIT_CUSTOM = 0x0211,
    [ParameterGroup("Metadata"), ParameterUpdateTime(600000)]
