...
public abstract class AbstractRDMCache : IDisposable
{
    ...
    protected ConcurrentDictionary<ERDM_Parameter, ParameterMetadata> parameterMetadataBag { get; private set; } = new ConcurrentDictionary<ERDM_Parameter, ParameterMetadata>();
    public virtual IReadOnlyDictionary<ERDM_Parameter, ParameterMetadata> ParameterMetadataBag
    {
